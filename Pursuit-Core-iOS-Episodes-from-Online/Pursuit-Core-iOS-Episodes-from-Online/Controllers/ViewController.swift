...
class ViewController: UIViewController {
        ...
        var filteredShow: [TVShowsWrapper]  {
        ...
        override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            guard let showVc = segue.destination as? EpisodesViewController else {
       ...
       private func loadData(word: String?){
            TVShowsWrapper.getShow(userInput: word){ (result) in
                switch result {
    ...
    extension ViewController: UITableViewDelegate, UITableViewDataSource{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            let cell = showTableVIew.dequeueReusableCell(withIdentifier: "showListCell", for: indexPath) as? TVShowTableViewCell
